            ...
            <div class="col-sm-3">
                <div class="single-item">
                    ...
                    <div class="single-item-header">
                        <a href="<?php echo e(route('detail.show', ['id' => $new_product->id])); ?>">
                            <img src="/source/image/product/<?php echo e($new_product->image); ?>" alt="" height="250px">
                        </a>
                    </div>
                    ...
                    <div class="single-item-caption">
                        ...
                        <a class="beta-btn primary" href="<?php echo e(route('detail.show', ['id' => $new_product->id])); ?>">Details <i class="fa fa-chevron-right"></i></a>
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\example-app\resources\views/banhang/index-show.blade.php ENDPATH**/ ?>